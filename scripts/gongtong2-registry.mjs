...
export const REG = [
  ...
  // ── Ⅰ-2. 원의 방정식 ─────────────────────────────────────────
  { unit: "I2", order: 0, sheet: "학습지 2-01 Q3·Q4 원의 방정식", desc: "중심 드래그·일반형↔표준형 변환·아폴로니오스의 원", title: "원의 방정식", book: "30~33", file: "gongtong2-04-circle-equation.html", height: 980,
    rp: "중심 (a,b), 반지름 r 인 원의 방정식이 (x−a)²+(y−b)²=r² 인 이유를 거리로 설명하고, x²+y²+Ax+By+C=0 꼴을 완전제곱으로 고쳐 중심·반지름을 찾는 과정을 예로 보이세요." },
  { unit: "I2", order: 1, sheet: "학습지 2-01 [생각 틔우기]·[실생활] 용접 로봇", desc: "컴퍼스로 원의 정의 → 두 원의 교점으로 작도 → 세 점을 지나는 원 찾기", title: "세 점을 지나는 원", book: "32~33", file: "gongtong2-04b-circle-three-points.html", height: 1000,
  ...
  { unit: "I2", order: 3, sheet: "학습지 2-02 Q5 [스스로 정리하기]", desc: "거리 d와 반지름 r 비교, 기하와 대수(판별식)가 만나는 지점", title: "원과 직선의 위치 관계", book: "34~36", file: "gongtong2-05-circle-line.html", height: 980,
  ...
  { unit: "I3", order: 2, sheet: "학습지 3-02 Q3~Q8 대칭이동", desc: "점의 네 대칭을 동시에. 두 대칭을 합성하면 회전이 나온다", title: "대칭이동", book: "48~51", file: "gongtong2-07-reflection.html", height: 980,
    rp: "점 (x,y) 를 x축, y축, 원점, 직선 y=x 에 대해 각각 대칭이동한 좌표를 정리하고, 도형의 방정식에서는 x·y 를 어떻게 바꾸는지 규칙으로 쓰세요." },
  { unit: "I3", order: 3, sheet: "학습지 3-02 Q3·Q5~Q7 · [생각 키우기]", book: "48~51", desc: "대칭 버튼으로 별 모으기 + 대칭의 합성 + 이동 순서를 바꾸면 어떻게 되는지", title: "⭐ 별 먹기 — 대칭이동", file: "gongtong2-07b-star-reflection.html", height: 1020,
    rp: "(1) 네 가지 대칭이동의 좌표 규칙을 표로 쓰세요. (2) 합성 실험실에서 x축 대칭 다음 y축 대칭이 무엇과 같았는지, 그 이유를 설명하세요. (3) 포물선 y = x² + 1 이 y축 대칭에서 변하지 않은 까닭을 식으로 설명하세요." },
  { unit: "I3", order: 4, sheet: "학습지 3-02 성취기준(상) · 최단 거리", desc: "강가·거울·당구 — 대칭이동으로 꺾인 길을 곧은 길로 바꾸기", title: "최단 경로 — 대칭이동의 쓸모", book: "51", file: "gongtong2-07d-shortest-path.html", height: 1000,
    rp: "(1) 왜 B 를 대칭이동해도 되는지 PB = PB′ 을 근거로 설명하세요. (2) 마을 A(−2, 3), B(6, 5) 일 때 최단 지점 P 의 좌표를 직접 계산해 구하세요. (직선 AB′ 의 방정식을 세우고 y = 0 을 대입)" },
  { unit: "I3", order: 5, sheet: "성취기준 ⑥⑦ 실생활 연결 · 데스모스 ‘테셀레이션’", desc: "평행이동·반사·회전을 조합해 평면을 빈틈없이 덮는 무늬 만들기", title: "🧩 테셀레이션 공방", book: "47", file: "gongtong2-07c-tessellation.html", height: 1000,
