...
export const REG = [
  ...
  { unit: "II", order: 20, desc: "[이전 버전] 집합 판별 퀴즈 + 부분집합 직접 만들기(2ⁿ의 의미)", title: "집합의 뜻과 포함관계", file: "gongtong2-08-sets-subset.html", height: 960,
    rp: "'집합'이 되려면 어떤 조건을 만족해야 하는지 쓰고, 부분집합(⊂)과 진부분집합의 차이를 예를 들어 설명하세요. 원소가 n개인 집합의 부분집합 개수가 2ⁿ 인 이유도 적어보세요." },
  { unit: "II", order: 21, desc: "[이전 버전] 클릭으로 영역 강조, 분배법칙을 벤 다이어그램으로 확인", title: "교집합과 합집합", file: "gongtong2-09-intersection-union.html", height: 1000,
  ...
  { unit: "II", order: 22, desc: "[이전 버전] 드모르간 법칙을 두 식이 같은 영역임을 눌러 비교", title: "여집합과 차집합", file: "gongtong2-10-complement-difference.html", height: 980,
    rp: "여집합 Aᶜ, 차집합 A−B 를 정의하고, 드모르간 법칙 (A∪B)ᶜ=Aᶜ∩Bᶜ 를 벤 다이어그램으로 확인한 과정을 설명하세요." },
  { unit: "II", order: 2, sheet: "학습지 ‘명제 1. 명제와 조건’ [지구는 평평한가?] 재설계", desc: "‘명제인가’와 ‘참인가’를 2단계로 분리 → 참+거짓 전제의 결론은 보장되지 않는다", title: "🌍 명제 판별기 — 지구는 평평한가?", file: "gongtong2-11b-proposition-detector.html", height: 1000,
